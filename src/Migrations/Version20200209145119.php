 ...
 */
final class Version20200209145119 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'User and Role entities';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, city_id INT NOT NULL, username LONGTEXT NOT NULL, email LONGTEXT NOT NULL, firstname LONGTEXT NOT NULL, lastname LONGTEXT NOT NULL, age INT DEFAULT NULL, studies LONGTEXT DEFAULT NULL, jobs LONGTEXT DEFAULT NULL, INDEX IDX_8D93D649F92F3E70 (country_id), INDEX IDX_8D93D6498BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
